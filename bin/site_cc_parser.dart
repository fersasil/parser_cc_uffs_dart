...
//   final a = await getNews();

//   final url = 'https://cc.uffs.edu.br/noticias/programa-practice/'; //a[0].url;
...
Future<dynamic> getContentFromUrl(String url) async {
...
Future<List<ParserSiteResponse>> getNews() async {
